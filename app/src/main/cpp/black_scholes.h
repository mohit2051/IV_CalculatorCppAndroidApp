...
#ifndef IMPLIED_VOLATILITY_CALCULATOR_BLACK_SCHOLES_H
#define IMPLIED_VOLATILITY_CALCULATOR_BLACK_SCHOLES_H
...
#endif //IMPLIED_VOLATILITY_CALCULATOR_BLACK_SCHOLES_H
