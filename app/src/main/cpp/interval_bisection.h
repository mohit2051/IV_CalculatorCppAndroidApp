...
#ifndef IMPLIED_VOLATILITY_CALCULATOR_INTERVAL_BISECTION_H
#define IMPLIED_VOLATILITY_CALCULATOR_INTERVAL_BISECTION_H
...
#endif //IMPLIED_VOLATILITY_CALCULATOR_INTERVAL_BISECTION_H
