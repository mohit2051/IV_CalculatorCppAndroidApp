...
#ifndef IMPLIED_VOLATILITY_CALCULATOR_NEWTON_RAPHSON_H
#define IMPLIED_VOLATILITY_CALCULATOR_NEWTON_RAPHSON_H
...
#endif //IMPLIED_VOLATILITY_CALCULATOR_NEWTON_RAPHSON_H
